...
q1.prepare("SELECT * FROM equipe");
q1.exec();

q2.prepare("SELECT * FROM equipe where nbr_equipe>10");
q2.exec();

q3.prepare("SELECT * FROM equipe where nbr_equipe>40");
q3.exec();

q4.prepare("SELECT * FROM equipe where nbr_equipe>100");
q4.exec();
