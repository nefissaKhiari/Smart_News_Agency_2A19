...
public:
    ...
    void setupUi(QDialog *add_article)
    {
        ...
        label->setGeometry(QRect(30, 20, 231, 41));
    ...
    void retranslateUi(QDialog *add_article)
    {
        ...
        label->setText(QApplication::translate("add_article", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#f90000;\">Details Articles</span></p></body></html>", Q_NULLPTR));
        ...
        type->insertItems(0, QStringList()
         << QApplication::translate("add_article", "            --", Q_NULLPTR)
         << QApplication::translate("add_article", "Sport ", Q_NULLPTR)
         << QApplication::translate("add_article", "Fashion", Q_NULLPTR)
         << QApplication::translate("add_article", "News", Q_NULLPTR)
         << QApplication::translate("add_article", "Art", Q_NULLPTR)
        );
    } // retranslateUi
