...
public:
    ...
    void setupUi(QDialog *add_journaliste)
    {
        ...
        label->setGeometry(QRect(40, 20, 231, 51));
        ...
        label_4->setGeometry(QRect(20, 143, 61, 16));
    ...
    void retranslateUi(QDialog *add_journaliste)
    {
        ...
        label->setText(QApplication::translate("add_journaliste", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#ff2600; vertical-align:super;\">Details Journaliste</span></p></body></html>", Q_NULLPTR));
        ...
        nb_articles->setPlaceholderText(QApplication::translate("add_journaliste", "        0", Q_NULLPTR));
        specialite->clear();
        specialite->insertItems(0, QStringList()
         << QApplication::translate("add_journaliste", "            --", Q_NULLPTR)
         << QApplication::translate("add_journaliste", "Sport", Q_NULLPTR)
         << QApplication::translate("add_journaliste", "Fashion", Q_NULLPTR)
         << QApplication::translate("add_journaliste", "News", Q_NULLPTR)
         << QApplication::translate("add_journaliste", "Art", Q_NULLPTR)
        );
    } // retranslateUi
